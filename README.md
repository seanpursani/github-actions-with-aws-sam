...
```bash
github-actions-with-aws-sam$ sam build
```
...
```bash
github-actions-with-aws-sam$ pip install pytest pytest-mock --user
github-actions-with-aws-sam$ python -m pytest tests/ -v
```
